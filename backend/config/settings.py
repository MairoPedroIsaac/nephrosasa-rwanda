"""
Django settings for HealthVault Rwanda project.
This file controls all backend configuration.
"""
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # CORS headers - allows frontend to talk to backend
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'healthvault_rwanda'),
...
# Mobile Money API Settings (you'll add real keys later)
