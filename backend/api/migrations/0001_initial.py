# Generated by Django 4.2 on 2026-06-08 20:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization', models.CharField(default='Nephrology', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_doctor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patients', to='api.doctorprofile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ai_risk_score', models.CharField(blank=True, choices=[('LOW', 'Low'), ('MEDIUM', 'Medium'), ('HIGH', 'High')], max_length=10, null=True)),
                ('confidence_percentage', models.FloatField(blank=True, null=True)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vital_logs', to='api.patientprofile')),
            ],
        ),
    ]
