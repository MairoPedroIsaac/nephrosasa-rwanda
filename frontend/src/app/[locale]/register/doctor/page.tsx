          ...
          <div className="hidden lg:flex flex-1 flex-col justify-center max-w-xl mx-auto w-full">
            <div className="mb-8 lg:mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold mb-6 leading-tight">
                Join Rwanda's
                <span className="block text-white mt-2">Healthcare Network</span>
              </h2>
            ...
            <div className="space-y-4 mb-8">
              <div className="bg-white/15 backdrop-blur-sm p-4 rounded-xl border border-white/25">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-white mb-1">Complete Patient History</h3>
                    <p className="text-white/80 text-sm">
                      See full medical records instantly
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/15 backdrop-blur-sm p-4 rounded-xl border border-white/25">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-white mb-1">QR Code Access</h3>
                    <p className="text-white/80 text-sm">
              ...
              <div className="bg-white/15 backdrop-blur-sm p-4 rounded-xl border border-white/25">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-white mb-1">Reduced Paperwork</h3>
                    <p className="text-white/80 text-sm">
              ...
              <div className="bg-white/15 backdrop-blur-sm p-4 rounded-xl border border-white/25">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-white mb-1">Mobile Money Payments</h3>
                    <p className="text-white/80 text-sm">
            ...
            <div className="border-t border-white/25 pt-6">
              ...
              <div className="mt-4 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30 inline-block">
                <div className="flex items-center gap-2">
                  <Check size={14} className="text-white" />
                  <span className="text-sm font-medium">Trusted by 200+ Healthcare Providers</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="text-center px-4">
              ...
              <div className="flex items-center justify-center gap-4">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs text-white/90">Better Care</span>
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-1.5 h-1.5 bg-green-400 rounded-full"></div>
                  <span className="text-xs text-white/90">Less Admin</span>
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-1.5 h-1.5 bg-green-400 rounded-full"></div>
